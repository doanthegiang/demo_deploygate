...
gpg --quiet --batch --yes --decrypt --passphrase="$IOS_KEYS" --output ./.github/secrets/a842f066-55fa-4359-ab09-ddd4cc0aa829.mobileprovision ./.github/secrets/a842f066-55fa-4359-ab09-ddd4cc0aa829.mobileprovision.gpg
